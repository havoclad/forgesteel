		...
		return (
			<Space orientation='vertical' style={{ width: '100%' }}>
				...
				<Select
					style={{ width: '100%' }}
					placeholder='Type'
					options={[ ItemType.Artifact, ItemType.Consumable, ItemType.Consumable1st, ItemType.Consumable2nd, ItemType.Consumable3rd, ItemType.Consumable4th, ItemType.LeveledArmor, ItemType.LeveledImplement, ItemType.LeveledWeapon, ItemType.Leveled, ItemType.Trinket1st, ItemType.Trinket2nd, ItemType.Trinket3rd, ItemType.Trinket4th ].map(option => ({ value: option }))}
