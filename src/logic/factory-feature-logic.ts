...
export class FactoryFeatureLogic {
	...
	createItemChoice = (data: { id: string, name?: string, description?: string, types?: ItemType[], count?: number }): FeatureItemChoice => {
		...
		return {
			...
			data: {
				types: data.types || [ ItemType.Artifact, ItemType.Consumable, ItemType.Consumable1st, ItemType.Consumable2nd, ItemType.Consumable3rd, ItemType.Consumable4th, ItemType.Leveled, ItemType.Trinket1st, ItemType.Trinket2nd, ItemType.Trinket3rd, ItemType.Trinket4th ],
				count: data.count || 1,
				selected: []
			}
		};
