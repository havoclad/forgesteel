...
describe('WarehouseService', () => {
	...
	mockAdapter.onPost('http://test-fake-host/connect').reply((config: AxiosRequestConfig) => {
	...
	describe('get', () => {
		test('calls the correct api endpoint with the correct authorization', async () => {
			...
			mockAdapter.onGet('data/forgesteel-heroes').reply((config: AxiosRequestConfig) => {
	...
	describe('put', () => {
		test('calls the correct api endpoint with the correct authorization', async () => {
			...
			mockAdapter.onPut('data/forgesteel-heroes').reply((config: AxiosRequestConfig) => {
				expect(config.headers?.Authorization).toBe('Bearer fake_token');
